...
export function pullRequestPreviewStyles(): string {
  return `
    ...
    .icon-button[data-tooltip]::after { content: attr(data-tooltip); position: fixed; z-index: 100; top: 40px; right: 10px; max-width: min(420px, calc(100vw - 20px)); padding: 4px 7px; border: 1px solid var(--vscode-widget-border); border-radius: 3px; color: var(--vscode-quickInput-foreground); background: var(--vscode-quickInput-background, var(--panel)); opacity: 0; pointer-events: none; white-space: normal; overflow-wrap: anywhere; }
    ...
    .branch-combobox:focus-within, .icon-button:focus-visible, .branch-combo-toggle:focus-visible, .tab:focus-visible, .file-view-button:focus-visible, .file-action:focus-visible, .file-toggle:focus-visible, .commit-row:focus-visible, .tree-row:focus-visible { outline: 1px solid var(--vscode-focusBorder); outline-offset: 1px; }
    ...
    .panel { min-width: 0; border: 1px solid var(--border); border-radius: 6px; background: var(--panel); overflow: hidden; }
        ...
        .file-view-button[data-tooltip]::after, .file-action[data-tooltip]::after, .file-toggle[data-tooltip]::after { content: attr(data-tooltip); position: fixed; z-index: 100; top: 52px; right: 12px; max-width: min(420px, calc(100vw - 24px)); padding: 4px 7px; border: 1px solid var(--vscode-widget-border); border-radius: 3px; color: var(--vscode-quickInput-foreground); background: var(--vscode-quickInput-background, var(--panel)); opacity: 0; pointer-events: none; white-space: normal; overflow-wrap: anywhere; font-weight: 400; }
