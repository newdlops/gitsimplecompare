...
브랜치별 커밋 히스토리 그래프를 웹뷰로 엽니다. 커밋 노드를 클릭하면 오른쪽에 상세가 표시되고, 변경 파일을 클릭하면 그 커밋의 diff 가 열립니다. 불러올 커밋 수는 `gitSimpleCompare.graph.maxCommits` 설정으로 조절합니다.
...
| `gitSimpleCompare.graph.maxCommits` | `300` | Git 그래프 뷰에서 불러올 최대 커밋 수 |
